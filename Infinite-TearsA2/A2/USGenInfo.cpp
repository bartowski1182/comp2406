...
////////////////////////////////////////////////////////////////////////////
void USGenInfo::drawGenInfo(int selection)
{
  int x, lx, y, ly, i;
  char c[GIMAX_BUF + 1];
...
////////////////////////////////////////////////////////////////////
int USGenInfo::drawCourseView(int selection)
{
  int x, y, i;
  char c[GIMAX_BUF + 1];
...
////////////////////////////////////////////////////////////////////
int USGenInfo::handleInput(char c)
{
...
//          value  </summary>                            //
///////////////////////////////////////////////////////////
int USGenInfo::handleSelection(int selection)
{
  if(index == 0)
  {
...
////////////////////////////////////////////////////////////////////
int USGenInfo::initCourseView(int prevIndex)
{
  clear();
