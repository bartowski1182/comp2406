...
Mainmenu::Mainmenu() : index(1), nBreaker(0), sMenu(0), aMenu(0)
{
  labels[0] = "Student";
  labels[1] = "Admin";
  labels[2] = "Quit";
...
////////////////////////////////////////////////////////////////////////////
void Mainmenu::drawMainMenu(int selection)
{
  clear();
...
////////////////////////////////////////////////////////////////////
int Mainmenu::handleInput(char c)
{
...
//          value  </summary>                            //
///////////////////////////////////////////////////////////
int Mainmenu::handleSelection(int selection)
{
...
void Mainmenu::studentMenu(ApplicationQueue **aq)
{
...
void Mainmenu::adminMenu(ApplicationQueue **aq)
{
